...
var sanitizeNames = _.map(_.compose(_underscore, _lowercase, _.prop('name')));
...
var formatit = _.compose(accounting.formatMoney, _.prop('dollar_value'));
var availablePrices = _.compose(_.join(', '), _.map(formatit), _.filter(_.prop('in_stock')));
...
// not quite pointfree :\
var carName = function(car) {
  return car.name + ' is the fastest';
}
var fastestCar = _.compose(carName, _.last, _.sortBy(_.prop('horsepower')));
